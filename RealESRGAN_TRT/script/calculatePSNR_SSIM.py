...
def main():
    ...
    a, b = Calculate(HR, SR, 100)
    print(a, b)

def Calculate(HRDir, SRDir, picNum):
    ...
    for i in range(1, picNum + 1):
        restored = SRDir + str(i) +'.png'
        gt = HRDir + str(i) + '.png'
        crop_border = 0
        img_restored = cv2.imread(restored, cv2.IMREAD_UNCHANGED).astype(np.float32) / 255.
