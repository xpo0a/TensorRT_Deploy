...
x3, y3 = [], []  # Pytorch
x4, y4 = [], [] # int8
str1 = '/home/ubuntu/Music/Real-ESRGAN_py/TXT_File/FP32/psnr.txt'
str2 = '/home/ubuntu/Music/Real-ESRGAN_py/TXT_File/FP16/psnr.txt'
str3 = '/home/ubuntu/Music/Real-ESRGAN_py/TXT_File/pytorch/psnr.txt'
str4 = '/home/ubuntu/Music/Real-ESRGAN_py/TXT_File/int8/psnr.txt'
...
plt.axis([0, 110, 10, 40])
plt.xlabel('img index')
# y轴文本
plt.ylabel('PSNR')
plt.title('Peak Sugnal to Noise Ratio')
plt.show()
