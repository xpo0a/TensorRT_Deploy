...
class ModelData(object):
    MODEL_PATH = "/home/ubuntu/Music/Real-ESRGAN-QAT_TRT/experiments/ONNX/90000_ONNX_fp32.onnx"
    OUTPUT_NAME = "output"
...
def build_int8_engine(onnx_filepath, calib, max_batch_size=6):
    ...
    with trt.Builder(TRT_LOGGER) as builder, builder.create_network(explicit_batch) as network, \
        ...
        with open('./model_INT8_9W.trt', "wb") as f:
            f.write(engine)
            print('success')
        return engine
...
if __name__ == '__main__':
    ...
    # cudaSetDevice(2)
    val_data = '/home/ubuntu/Music/TRT_data/INT8_data/'
    calibration_cache = "/home/ubuntu/Pictures/Real-ESRGAN_py/int8_v3/db_calibration_1.cache"
